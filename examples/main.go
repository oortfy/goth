...
import (
	...
	"github.com/oortfy/goth/gothic"
	"github.com/oortfy/goth/providers/amazon"
	"github.com/oortfy/goth/providers/apple"
	"github.com/oortfy/goth/providers/auth0"
	"github.com/oortfy/goth/providers/azuread"
	"github.com/oortfy/goth/providers/battlenet"
	"github.com/oortfy/goth/providers/bitbucket"
	"github.com/oortfy/goth/providers/box"
	"github.com/oortfy/goth/providers/dailymotion"
	"github.com/oortfy/goth/providers/deezer"
	"github.com/oortfy/goth/providers/digitalocean"
	"github.com/oortfy/goth/providers/discord"
	"github.com/oortfy/goth/providers/dropbox"
	"github.com/oortfy/goth/providers/eveonline"
	"github.com/oortfy/goth/providers/facebook"
	"github.com/oortfy/goth/providers/fitbit"
	"github.com/oortfy/goth/providers/gitea"
	"github.com/oortfy/goth/providers/github"
	"github.com/oortfy/goth/providers/gitlab"
	"github.com/oortfy/goth/providers/google"
	"github.com/oortfy/goth/providers/gplus"
	"github.com/oortfy/goth/providers/heroku"
	"github.com/oortfy/goth/providers/instagram"
	"github.com/oortfy/goth/providers/intercom"
	"github.com/oortfy/goth/providers/kakao"
	"github.com/oortfy/goth/providers/lastfm"
	"github.com/oortfy/goth/providers/line"
	"github.com/oortfy/goth/providers/linkedin"
	"github.com/oortfy/goth/providers/mastodon"
	"github.com/oortfy/goth/providers/meetup"
	"github.com/oortfy/goth/providers/microsoftonline"
	"github.com/oortfy/goth/providers/naver"
	"github.com/oortfy/goth/providers/nextcloud"
	"github.com/oortfy/goth/providers/okta"
	"github.com/oortfy/goth/providers/onedrive"
	"github.com/oortfy/goth/providers/openidConnect"
	"github.com/oortfy/goth/providers/patreon"
	"github.com/oortfy/goth/providers/paypal"
	"github.com/oortfy/goth/providers/salesforce"
	"github.com/oortfy/goth/providers/seatalk"
	"github.com/oortfy/goth/providers/shopify"
	"github.com/oortfy/goth/providers/slack"
	"github.com/oortfy/goth/providers/soundcloud"
	"github.com/oortfy/goth/providers/spotify"
	"github.com/oortfy/goth/providers/steam"
	"github.com/oortfy/goth/providers/strava"
	"github.com/oortfy/goth/providers/stripe"
	"github.com/oortfy/goth/providers/tiktok"
	"github.com/oortfy/goth/providers/twitch"
	"github.com/oortfy/goth/providers/twitter"
	"github.com/oortfy/goth/providers/twitterv2"
	"github.com/oortfy/goth/providers/typetalk"
	"github.com/oortfy/goth/providers/uber"
	"github.com/oortfy/goth/providers/vk"
	"github.com/oortfy/goth/providers/wecom"
	"github.com/oortfy/goth/providers/wepay"
	"github.com/oortfy/goth/providers/xero"
	"github.com/oortfy/goth/providers/yahoo"
	"github.com/oortfy/goth/providers/yammer"
	"github.com/oortfy/goth/providers/yandex"
	"github.com/oortfy/goth/providers/zoom"
)
