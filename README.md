# Goth: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/oortfy/goth?status.svg)](https://godoc.org/github.com/oortfy/goth) [![Build Status](https://github.com/oortfy/goth/workflows/ci/badge.svg)](https://github.com/oortfy/goth/actions) [![Go Report Card](https://goreportcard.com/badge/github.com/oortfy/goth)](https://goreportcard.com/report/github.com/oortfy/goth)
...
```text
$ git clone git@github.com:oortfy/goth.git
```
or use
```text
$ go get github.com/oortfy/goth
