...
See https://github.com/oortfy/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/oortfy/goth/examples/main.go to see this in action.
*/
